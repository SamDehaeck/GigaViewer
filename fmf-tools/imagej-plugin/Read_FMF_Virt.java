...
public class Read_FMF_Virt implements PlugIn {
...
//					IJ.showMessage(form+" = "+"RGB8");
                ...
                IJ.run("Raw...", "open=["+DIRECTORY+FILENAME+"] image="+format+" width="+cols+" height="+rows+" offset="+FILE_OFFSET+" number="+amount+" gap="+FILE_GAP+" little-endian"+" use");
